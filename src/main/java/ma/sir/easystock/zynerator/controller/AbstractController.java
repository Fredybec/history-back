...
@Value("${uploads.location.directory}")
 ...
 @Value("${uploads.location.temp}")
    ...
    public ResponseEntity<AchatHistory> findHistoryAchatById(Long id) throws Exception {
        AchatHistory h = service.findHistoryAchatById(id);
        return new ResponseEntity<>(h, HttpStatus.OK);
    }
    ...
    public List<AchatHistory> findAllHistory() {
        return service.findHistoryByCriteria(null);
    }
