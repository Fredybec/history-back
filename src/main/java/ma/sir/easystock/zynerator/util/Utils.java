...
public abstract class Utils {
    ...
    private static <T extends Object> Method constructMethode(T newVal, T oldVal, Method method) throws NoSuchMethodException {
        Method method2 = null;
        if (oldVal != null)
    ...
    public static <T extends AuditBusinessObject> boolean compareObjectsDiff(T newVal, T oldVal) throws NoSuchMethodException {
        for (Method method : newVal.getClass().getDeclaredMethods()) {
            Annotation tagAnnotation = logAnnotation(method);
            if (tagAnnotation != null) {
                Object value1 = getMethodValue(method, newVal, tagAnnotation);
