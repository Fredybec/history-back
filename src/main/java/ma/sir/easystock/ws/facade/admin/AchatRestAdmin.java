...
public class AchatRestAdmin  extends AbstractController<Achat, AchatDto, AchatHistory, AchatCriteria, AchatHistoryCriteria, AchatAdminService, AchatConverter> {
    ...
    public ResponseEntity<AchatHistory> findHistoryAchatById(@PathVariable("id") Long id) throws Exception {
        return super.findHistoryAchatById(id);
    }
    ...
    @ApiOperation("Gets achat history by criteria")
    @GetMapping("history-by-criteria")
    public List<AchatHistory> findAllHistory() {
